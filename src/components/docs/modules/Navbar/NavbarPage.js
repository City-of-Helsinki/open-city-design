...
import NavbarTogglerExample from './NavbarToggler';
const NavbarExampleSource = require('!!raw-loader!./Navbar');
const NavbarTogglerExampleSource = require('!!raw-loader!./NavbarToggler');
