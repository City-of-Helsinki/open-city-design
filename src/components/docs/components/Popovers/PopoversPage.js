...
import PopoverExampleMulti from './PopoverMulti';

const PopoverExampleSource = require('!!raw-loader!./Popover');
const PopoverExampleMultiSource = require('!!raw-loader!./PopoverMulti');
