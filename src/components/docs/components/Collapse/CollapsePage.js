...
import CollapseEventsExample from './CollapseEvents';
const CollapseExampleSource = require('!!raw-loader!./Collapse');

const CollapseEventsExampleSource = require('!!raw-loader!./CollapseEvents');
