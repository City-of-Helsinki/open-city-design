...
import CarouselUncontrolledExample from './CarouselUncontrolled';
import CarouselCustomTagExample from './CarouselCustomTag';
const CarouselExampleSource = require('!!raw-loader!./Carousel');
const CarouselUncontrolledExampleSource = require('!!raw-loader!./CarouselUncontrolled');
const CarouselCustomTagExampleSource = require('!!raw-loader!./CarouselCustomTag');
